...
function ImmigrationOfficerLogin(props) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    props.loginImmigrationOfficer(state.email, state.password);
  };
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 1 }}>
            ...
            <Grid container>
              ...
              <Grid item>
                <Link href="/immigration-officer/signup" variant="body2">
...
export default connect(null, { loginImmigrationOfficer })(
  ImmigrationOfficerLogin
);
